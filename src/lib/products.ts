...
export const products: Product[] = [
  ...
  },
  {
    ...
    reviewCount: 67,
    variants: [
      { name: "Color", options: [{ label: "Black" }, { label: "White" }] },
    ],
  ...
  },
  {
    ...
    reviewCount: 112,
    variants: [
      { name: "Color", options: [{ label: "Black" }, { label: "White" }, { label: "Silver" }, { label: "Rose Gold" }] },
    ],
    createdAt: "2026-06-10",
    status: "live",
    supplier: {
  ...
  },
  {
    ...
    reviewCount: 31,
    variants: [
      { name: "Color", options: [{ label: "Brown" }, { label: "Black" }] },
    ],
    createdAt: "2026-06-10",
    status: "live",
    supplier: {
  ...
  },
  {
    ...
    reviewCount: 47,
    variants: [
      { name: "Color", options: [{ label: "Black" }, { label: "Coffee" }] },
    ],
    createdAt: "2026-06-10",
    status: "live",
    supplier: {
  ...
  },
  {
    ...
    reviewCount: 58,
    variants: [
      { name: "Color", options: [{ label: "Black" }, { label: "Pink" }, { label: "Purple" }, { label: "Blue" }] },
    ],
    createdAt: "2026-06-10",
    status: "live",
    supplier: {
